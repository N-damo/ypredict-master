...
setup(name='Ypredict',version='0.0.3',description='a very fast Y-haplogroup caller',long_description=long_description, url='https://github.com/N-damo/ypredict-master',
